...
std::string home::genText(const DrTemplateData& home_view_data)
{
    ...
    auto params = home_view_data.get<std::unordered_map<std::string, std::string, drogon::utils::internal::SafeStringHash>>("params");
	...
	home_tmp_stream << "    <title>Learn To Type</title>   \n";
	home_tmp_stream << "</head>\n";
home_tmp_stream<<"\n";
	...
	home_tmp_stream << "        <a class=\"navbar-brand\" href=\"/\">Learn To Type</a>\n";
...
home_tmp_stream<<"\n";
	...
	home_tmp_stream << "                    <a class=\"nav-link\" href=\"/home/\">Home</span></a>\n";
	home_tmp_stream << "                </li>\n";
	home_tmp_stream << "            </ul>\n";
	home_tmp_stream << "            <ul class=\"navbar-nav mr-auto\">\n";
	home_tmp_stream << "                <li class=\"nav-item active\">\n";
	home_tmp_stream << "                    <a class=\"nav-link\" href=\"/typing/\">Typing</span></a>\n";
	home_tmp_stream << "                </li>\n";
	home_tmp_stream << "            </ul>\n";
	home_tmp_stream << "            ";
 if (user.empty()) {
	...
	home_tmp_stream << "            <span class=\"navbar-text\">\n";
	home_tmp_stream << "                <a class=\"nav-link\" href=\"/auth/logout\">";
